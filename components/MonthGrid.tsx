                  ...
                  <div
                    ...
                    ${
                      isActive
                        ...
                        : "bg-[#1e293b] border-[#5a6b7a]/60"
                    }
                    ${
                      isClickable
                        ? "cursor-pointer ring-2 ring-offset-2 ring-offset-[#0f172a] ring-gray-400 hover:border-gray-400"
                        : "cursor-default"
                    }
                  ...
                  */}
                  {isVisible && (
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block z-50 whitespace-nowrap pointer-events-none">
                      <div className="bg-[#1f2937] text-white text-xs px-2 py-1.5 rounded-md shadow-xl border border-[#374151] font-medium relative">
                        {getFormattedDateString(dateStr)}
                        {/* Tiny Arrow for tooltip */}
                        <div className="absolute top-full left-1/2 -translate-x-1/2 w-0 h-0 border-x-4 border-x-transparent border-t-4 border-t-[#374151]"></div>
                      </div>
                    </div>
                  )}
                </div>
